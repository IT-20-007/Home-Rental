          ...
          <a href="#" class="toggle-button">
            ...
            <div class="navbar-links">
              <ul class="nav-list">
                ...
                <li class="nav-items"><a href="http://localhost/Project/View_Homes.php?search=">View Homes</a></li>
    ...
    <div id="carouselExampleIndicators" class="carousel slide">
        ...
        <div class="carousel-inner">
          ...
          ?> -->
            ...
            <img src="/Project/Login Page/<?php echo $row['property_images']; ?>" height = "500" width = "400" class="d-block w-100" alt="...">
          
          </div>
          <div class="carousel-item">
            <!-- <img src="2.jpg" class="d-block w-100" alt="...">-->
            <img src="/Project/Login Page/<?php echo $row['property_images1']; ?>" height = "500" width = "400" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <!--<img src="1.jpg" class="d-block w-100" alt="...">-->
            <img src="/Project/Login Page/<?php echo $row['property_images2']; ?>" height = "500" width = "400" class="d-block w-100" alt="...">
          </div> 
          <div class="carousel-item">
            <!--<img src="1.jpg" class="d-block w-100" alt="...">-->
            <img src="/Project/Login Page/<?php echo $row['property_images3']; ?>" height = "500" width = "400" class="d-block w-100" alt="...">
          </div> 
          <div class="carousel-item">
            <!--<img src="1.jpg" class="d-block w-100" alt="...">-->
            <img src="/Project/Login Page/<?php echo $row['property_images4']; ?>" height = "500" width = "400" class="d-block w-100" alt="...">
          </div> 
          <div class="carousel-item">
            <!--<img src="1.jpg" class="d-block w-100" alt="...">-->
            <img src="/Project/Login Page/<?php echo $row['property_images5']; ?>" height = "500" width = "400" class="d-block w-100" alt="...">
          </div> 
        </div>
