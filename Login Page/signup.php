            ...
            <form action="signup.php" method="post" class="form-input text-center">
                <ul>
                    ...
                    <div class="signup_content">
                        <input type="text" placeholder="Username" name="username" id="username" class="user-input" required>
                        <input type="email" name="email" id="email" placeholder="Email" class="user-input" required>
                        ...
                        <input type="tel" name="whatno" id="wno" placeholder="Whatsapp Number" class="user-input" required pattern="[0-9]{10}" >
